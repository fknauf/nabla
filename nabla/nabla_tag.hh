...
namespace nabla {
    ...
    namespace traits {
        ...
        template <typename T>
        using nabla_equivalent = std::conditional_t<is_nabla_expression<T>, plain_type<T>, expr::constant>;
        
        template <typename T>
        using negated_nabla_equivalent = std::conditional_t<is_nabla_variable<T>, expr::negation<plain_type<T>>, expr::constant>;
