...
namespace nabla {
  namespace impl {
    ...
    struct hessian_matrix_builder {
      ...
      static void build(matrix<Dimension, Dimension> &dest,
                        Function               const &f,
    ...
    template<int Dimension> struct hessian_matrix_builder<Dimension, Dimension, 0> {
      template<typename Function> static void build(matrix<Dimension, Dimension> &,
                                                    Function               const &,
  ...
  template<traits::nabla_expression Function,
           traits::nabla_value... Args>
